    ...
    public function run()
    {
		...
		for ($i=1;$i<=10;$i++):
		     ...
		     DB::table('jugadores')->insert([
				 ...
				 'ELO'=>$elo,		 
				 'titulo_jugador'=>$this->getTitulo($elo),
				 'fecha_titulo'=>$faker->date,
				 'nacionalidad_jugador'=>$faker->unique()->randomElement(self::$arrayPais),
				 'email_jugador'=>$faker->email,
				 'telefono_jugador'=>$faker->phoneNumber,			
				 "club_id"=>$faker->numberBetween(1,7),
			 ]);
	    endfor;
    }
}